...
const Login = () => {
  ...
  const handleGoogleLogin = async (credentialResponse) => {
    try {
      setLoading(true);
      // Giải mã thông tin người dùng từ Google
      const decoded = jwtDecode(credentialResponse.credential);
      console.log("Thông tin người dùng Google:", decoded);
      console.log("end point", endpoints['google-login']);
      

      // Gửi thông tin đến backend để xử lý đăng nhập/đăng ký
      ...
      // Redirect về trang dashboard của client
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-sm">
        <h1 className="text-2xl font-semibold text-center mb-4">Đăng nhập Client</h1>
        {msg && (
          <div className="bg-red-100 text-red-700 p-2 rounded mb-4 text-center text-sm">
            {msg}
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center">
            <p className="text-center text-sm text-gray-600 mb-2">Đăng nhập bằng</p>
            <div className="flex justify-center">
              <GoogleLogin
